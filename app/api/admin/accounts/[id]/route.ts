...
export async function PATCH(
  ...
  try {
    ...
    return jsonNoStore({ error: "Unable to update this account right now." }, { status: 500 });
  }
  ...
  if (action === "approve") {
    ...
    try {
      ...
      return jsonNoStore({ error: "Unable to approve this account right now." }, { status: 500 });
    }
  ...
  try {
    ...
    return jsonNoStore({ error: "Unable to disapprove this account right now." }, { status: 500 });
  }
